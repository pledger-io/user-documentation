...
|Download
|link:https://jdocstorage.z6.web.core.windows.net/project/fintrack/FinTrack%20Setup%202.2.0.exe[FinTrack Setup 2.2.0.exe]
|===
...
|Download
|link:https://jdocstorage.z6.web.core.windows.net/project/fintrack/FinTrack%20Setup%202.0.0.exe[FinTrack Setup 2.0.0.exe]
|===