...
.Main import process
[.scalable-image]
image::architecture/process/user.profile.import.png[Profile import process]

=== Transaction rule sub-process

.Sub-process for transaction rules
[.scalable-image]
image::architecture/process/transaction.rules.import.png[Sub-process transactionrules import]
