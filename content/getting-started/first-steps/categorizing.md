---
title: Creating and categorizing transactions
description: Organizing your transactions with budgets and categories.
icon: fas tags
thumbnail: img/getting-started/categorizing-overview.svg
show_thumbnail: false
type: docs
weight: 3
---
Recording transactions into Pledger.io is the first step in managing your finances.
...
This guide will show you how to create and categorize transactions in Pledger.io.
The guide will not go into how to budget, but will show you how to categorize transactions using categories and tags.
Budgeting is covered in [another guide](/how-to/your-finances/budgeting/).

>[!NOTE]
> This guide assumes you have already [set up your accounts](/getting-started/first-steps/first-account/) in Pledger.io.

## Understanding how categories work

In Pledger.io, transactions can be categorized in multiple ways:

* By using budgets, read [here](/concepts/financial/budgets/) to get insight into what budgets are.
* By using categories
...
{{< image src="img/getting-started/catagorizing/empty-category-overview.png" caption="The category overview page" >}}
...
{{< image src="img/getting-started/catagorizing/add-category-form.png" caption="The category form" >}}
...
{{< image src="img/getting-started/catagorizing/create-transaction-buttons.png" caption="The add transaction dropdown" >}}

You will have to select the account you want to use as the source, this is one of your own accounts in Pledger.io.
After selecting the account click `Next`, you can now fill in the details of the transaction.

{{< image src="img/getting-started/catagorizing/select-source-account-dialog.png" caption="The account selection" wrapper="col-3 mx-auto" >}}
...
{{< image src="img/getting-started/catagorizing/categorize-transactions.png" caption="The transaction create form" >}}
...
{{< image src="img/getting-started/catagorizing/categorized-transaction-in-overview.png" caption="The transaction overview" >}}
