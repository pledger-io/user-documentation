---
title: Creating your first account and transactions
description: Setting up your first bank accounts and recording your first transactions in Pledger.io.
icon: fas wallet
thumbnail: img/getting-started/first-account-overview.svg
show_thumbnail: false
type: docs
weight: 2
---
Once you have [your account set up](/getting-started/first-steps/create-user/), you can start creating accounts and transactions.
...
{{< image src="img/getting-started/first-accounts/account-menu-part.png" caption="The account menu" wrapper="col-3 mx-auto" >}}
...
{{< image src="img/getting-started/first-accounts/account-overview.png" caption="The account overview page" >}}
...
{{< image src="img/getting-started/first-accounts/add-own-account.png" caption="The add account form" >}}
...
{{< image src="img/getting-started/first-accounts/transactions-buttons.png" caption="The transaction buttons" >}}
...
{{< image src="img/getting-started/first-accounts/add-expense-form.png" caption="The add expense form" >}}
...
{{< image src="img/getting-started/first-accounts/transaction-overview.png" caption="The transaction overview page" >}}
